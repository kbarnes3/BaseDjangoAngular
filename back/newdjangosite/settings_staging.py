...
ENV = environ.Env()
environ.Env.read_env('/var/www/python/newdjangosite-staging-secrets/staging/staging.env')
...
# Real outbound email over SMTP. Credentials come from the staging secrets env file.
MAILERS = {
    'default': {
