...
For consistency, the only OS supported for a server is Ubuntu Server 22.04.
...
1. Set up a new Ubuntu Server 22.04 install, following the official documentation
